...
const translations = {
  en: {
    ...
    git_desc_researcher:   'Applied research in explainability: so companies can understand and trust their own models.',
    ...
    tch2_badge:            'Course',
    tch2_title:            'AI & NLP Course',
    tch2_desc:             'A course for people with a humanities background who want to learn AI in a practical way. From getting started to understanding how an LLM works.',
    tch2_link:             'View the course',
    tch3_badge:            'Outreach',
